        ...
        <div class=" mx-auto sm:px-6 lg:px-6">
            <div class="bg-white dark:bg-gray-800 md:mr-20 md:ml-20 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 relative">
                    ...
                    <div
                        class="absolute z-10 w-4 ms:h-auto md:h-auto md:w-full bg-withe flex items-center justify-center"
                                ...
                                <div class="m-2 mt:4 md:mt-8 flex justify-between items-center z-100 h-auto">
                                    ...
                                    ">
                                        <a href="{{ route('show.index') }}"
                                           class="bg-withe-200 hover:bg-withe text-white font-semibold py-2 px-2 rounded focus:outline-none focus:shadow-outline">Acheter
                                            un ticket</a>
                                        <!-- repertoire -->
                                        <div>
                                            <a class="flex justify-center items-center font-semibold text-base text-white"
                        ...
                        <div
                            ...
                            <div class="
                                ...
                                <div class="flex justify-center items-center">
                                    <h2 class="text-7xl ml-20 font-semibold font-macamore text-withe dark:text-withe-100 md:text-9xl">
                                        Credit Alejandro</h2>
                                </div>
