                            ...
                            @foreach ($currentPrices as $price)
                                <div class="flex items-center space-x-4">
                                    ...
                                    <input
                                        ...
                                        x-on:input="updateTotal($event.target.form);"
                                        type="number"
                                        name="places[{{ $price->type }}]"
                                        id="places_{{ $price->type }}"
                                        class="border border-gray-300 dark:border-gray-600 p-2 w-16"
                                        data-price="{{ $price->price }}"
                                        data-max-seats="{{ $price->available_seats }}"
                                        min="0"
                                        value="0"
                                        required
                                    >
