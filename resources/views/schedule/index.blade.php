<x-app-layout>
        <div class="flex justify-center flex-col py-6 px-4 md:flex-row md:px-0 md:mr-24 md:ml-24 md:py-6">
            ...
            <div class="w-full md:w-2/3 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mx-2 md:mx-1 mb-4">
                <div class="sm:min-w-36 p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="col-md-8 mt-6">
                                <div class="flex justify-between items-center w-full">
                                    <a class="relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 font-medium text-gray-700 hover:bg-gray-50"
                                       rel="prev" href="{{ route('schedule.index', ['date' => $previousDay]) }}"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512"
                                    ...
                                    <span class="mx-2 text-gray-600 font-medium border border-gray-300 rounded-md px-4 py-2">{{ $currentDayFormatted['formattedDate'] }}</span>

                                    <a class="relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 font-medium text-gray-700 hover:bg-gray-50"
                                       rel="next" href="{{ route('schedule.index', ['date' => $nextDay]) }}">Demain &nbsp; <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                    ...
                                    <div class="bg-white px-5 mt-10 rounded-lg border border-gray-300 overflow-hidden mb-6">
                                        <div class="p-4">
                                            ...
                                            <div class="flex justify-between items-center mt-4">
                                                <p class="text-gray-600">Lieu: {{ $representation['location']['designation'] }}</p>
